...
class ItemAddMonthController(private val activity: Activity, var userModel: UserModel, private var lnRoot: LinearLayout, private var callback: DataCallback) : View.OnClickListener {
